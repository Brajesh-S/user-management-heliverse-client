...
// import { Container, Grid, Typography,Button, Dialog } from '@mui/material';
...
//   useEffect(() => {
//     dispatch(fetchUsers({ page, searchTerm, ...filters }));
...
//         User Management
//       </Typography>
//       <Button variant="contained" color="primary" onClick={handleOpenTeamList} sx={{ mb: 2 }}>
//         View Teams
//       </Button>
...
//           <Filters 
//             domains={['IT', 'Sales', 'Marketing', 'Business Development', 'Finance', 'UI Designing','Management']} 
//             genders={['Male', 'Female']}
...
//         </Grid>
//       </Grid>
//       <Dialog fullWidth maxWidth="md" open={openTeamList} onClose={handleCloseTeamList}>
